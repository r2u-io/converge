...
const Header: React.FC = () => {
  ...
  return (
    <Container>
      ...
      <div className='menu'>
        <a href='#about'>
          <button type='button'>{t('header.about')}</button>
        </a>
        <a href='#strategy'>
          <button type='button'>{t('header.strategy')}</button>
        </a>
        <a href='#experience'>
          <button type='button'>{t('header.experience')}</button>
        </a>
        <a href='#nft'>
          <button type='button'>{t('header.nft')}</button>
        </a>
        <a href='#collection'>
          <button type='button'>{t('header.collection')}</button>
        </a>
        <a href='#team'>
          <button type='button'>{t('header.team')}</button>
        </a>

        <a
          href='https://www.linkedin.com/company/converge-land/'
          target='_blank'
